...
This is given by Google sample. Here I am trying to add different kind of models and trying it out. In this project I have added 4 models in that two are 4bit and 2 are 8bit models. The 4bit models give more performance so trying using that.
